...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'catNumber', description: 'Cat number (0-based)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'txHash', description: 'Transaction hash (64-char hex)' }),
    openapi.ApiResponse({ status: 200, type: require("./dto/cat.dto").CatDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'itemsPerPage', description: 'Number of cats per page (max 100)' }),
    (0, swagger_1.ApiParam)({ name: 'currentPage', description: 'Page number (1-based)' }),
